        ...
        <div className="fixed inset-0 z-[90] bg-ink-950/80 backdrop-blur-sm flex items-center justify-center p-6" onClick={close}>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select className="input-field" value={form.category} onChange={(e) => setForm((f) => ({ ...f, category: e.target.value }))}>
                  ...
                  <option value="Workshop">Workshop (appears in the Workshops row)</option>
            ...
            <p className="text-xs text-ink-400 -mt-2">
              Events are sorted into <span className="text-circuit font-mono">Ongoing</span> or{" "}
              <span className="text-circuit font-mono">Past</span> automatically based on the date above — no
